...
function about() {
  return (
    ...
    <ul>
      <li><strong>Black Coffee of the Day</strong> — Experience the distinct taste of our locally roasted beans, freshly selected for you.</li>
      <li><strong>Double Espresso</strong> — A bold shot of energy to kickstart your day.</li>
      <li><strong>Light Roast</strong> — Sourced from Morocco, these lightly roasted beans offer delicate and vibrant notes.</li>
      <li><strong>Lungo</strong> — A medium roast that’s perfectly balanced and smooth.</li>
      <li><strong>Mocha & Oat Latte</strong> — Creamy, indulgent options made with our signature beans and oat milk for a delicious twist.</li>
    </ul>
